...
{
    public partial class Recommand_Friend : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection scon = new SqlConnection(connString.ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select * from Get_Recommand_Friend2('" + User_id + "', 1)", scon);
                    ...
                    //루트 설정
                    writer.WriteStartElement("friend_list");
                    int i = 0;

                    while (rd.Read())
                    {
                        writer.WriteStartElement("friend_info");
